...
public abstract class AbstractRestController implements ApplicationEventPublisherAware {
	...
	Counter http400Counter = Metrics.counter("com.rollingstone.TemplateService.HTTP400.count");
	
	Counter http404Counter = Metrics.counter("com.rollingstone.TemplateService.HTTP404.count");
