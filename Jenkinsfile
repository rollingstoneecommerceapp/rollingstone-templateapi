node {
   ...
   stage('Prepare') {
      ...
      ORGANIZATION_NAME='rollingstoneecommerceapp'
   }
                     ...
                     publishers: [
                        sshPublisherDesc(
                           ...
                           transfers: [
                              ...
                              sshTransfer(
                                 execTimeout: 999999,
                                 sourceFiles: "udeploy.yaml,${appname}-deployment-playbook-qa.yaml,k8s-config.yaml,k8s-role.yaml",
                                 removePrefix: "",
                                 remoteDirectory: "${appname}-qa/workspace",
                     ...
                     publishers: [
                        sshPublisherDesc(
                           ...
                           transfers: [
                              ...
                              sshTransfer(
                                 execTimeout: 999999,
                                 sourceFiles: "udeploy.yaml,${appname}-deployment-playbook.yaml,k8s-config.yaml,k8s-role.yaml",
                                 removePrefix: "",
                                 remoteDirectory: "${appname}/workspace",
